...
#Con ROIs, se identifican las distancias máximas entre monedas y se pone un valor aproximado de d^2=80 para identificar
#si un pixel negro hace parte o no de un conjunto de una moneda
